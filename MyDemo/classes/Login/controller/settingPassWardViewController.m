...
- (void)createTextFields
{
    ...
    passward = [self createTextFielfFrame:CGRectMake(100, 10, 200, 30) font:[UIFont systemFontOfSize:14]
...
bgView.frame.size.height + bgView.frame.origin.y + 30 + 24, self.view.frame.size.width - 20, 37) backImageName:nil
